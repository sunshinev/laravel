...
class ArticleController extends Controller {
    ...
    public function save(Request $request) {
        ...
        // save
        if ($article_id && Article::where('article_id', $article_id)->first()) {
            $r = Article::where('article_id', $article_id)
                        ->update([
            ...
            // 生成新的article_id
            $article_id = $category_id.md5($article_title.microtime(true)).microtime(true);
