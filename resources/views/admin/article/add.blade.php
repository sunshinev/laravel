...
@section("right")
    ...
    <div class="row">
        <div class="col-md-12" id="category_list">
            <p>栏目关联</p>
            <div class="btn-group" id="level_1" style="margin-right:5px;">
                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <span id="action_1">选择栏目</span><span class="caret"></span>
                </button>
    ...
    <div class="row">
        <div class="col-md-5">
            <label>文章内容</label>
            <textarea id="article_content" class="form-control" placeholder="## 内容" style="min-height: 200px;" rows="30" oninput="Editor.mark()"></textarea>
